...
For Modes 2–4, skip the pipeline-specific Input fields and output a structured findings report to `.claude/runs/task-briefs/<YYYY-MM-DD>_<slug>_research.md` instead of `idea_output_path`.
