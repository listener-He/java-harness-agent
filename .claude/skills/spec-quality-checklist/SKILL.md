...
description: "Verifies AI-generated docs (task_brief, specs, WAL) for clarity + actionability. TRIGGER: manually after drafting, before submit/gate. NOT FOR: code review (use code-reviewer / code-review-checklist)."
---
