# Active Specs (Task Briefs)

This index lists `<YYYY-MM-DD>_<slug>_task_brief.md` documents that are currently in progress or recently finished and still frequently referenced.
