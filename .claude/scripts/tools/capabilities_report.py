...
PHASE_ROUTING: list[dict] = [
    ...
    },
    {
        ...
        "notes": "write task_brief; HIGH needs ≥2 ADRs",
    },
    {
        "phase": "3. Review",
        "agent": "code-reviewer",
...
QUICK_ROUTING: list[tuple[str, str]] = [
    ...
    ("@standard / HIGH 改动 (DB/auth/error-code)", "上面 + Approval Gate + ≥2 ADR + adversarial-review"),
    ...
    ("DB migration / DDL", "Scenario B — migration-planner + Approval Gate"),
