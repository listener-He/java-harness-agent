...
- **Task**: Understand user intent, drill-down through the `sitemap.md`, and orchestrate the multi-flow launch plan.
...
- **Action**: Follow the `Archive` hook protocols in `harness/hooks.md`.
