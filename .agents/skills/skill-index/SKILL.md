...
| [deepinit](../deepinit/SKILL.md) | Deep initialization: generates hierarchical AGENTS.md files + machine-readable `context_brief.md` for downstream skill consumption. |
