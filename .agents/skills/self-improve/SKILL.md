...
1. **Eval baseline REQUIRED**: Read `<slug>_baseline.json` from `.agents/workflow/runs/`. Extract `baseline_score`. If file does not exist → STOP: “Run eval-harness first. No baseline_score to anchor improvement to.”
