...
- .agents/llm_wiki/schema/subagent_contract_schema.md

Expected artifact convention (recommended):
- .agents/workflow/runs/<YYYY-MM-DD>_<slug>_delegation_<id>.md
...
def _match_files(root_dir: str, topic: str, date: str) -> list[str]:
    root_dir = root_dir or ".agents/workflow/runs"
...
def main() -> int:
    ...
    parser.add_argument("--dir", default=".agents/workflow/runs", help="Directory to search for delegation artifacts")
